...
import com.example.armando.instapoo.Utils.SectionsStatePagerAdapter;
...
public class AccountSettingsActivity extends AppCompatActivity {
    ...
    private static final int ACTIVITY_MAIN =4;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        backArrow.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Log.d(TAG, "onClick: navigating back to 'ProfileActovity'");
                finish();
            }
        });
    }
    ...
    private void setupSettingsList() {
        Log.d(TAG, "setupSettingsList: initialing 'Account Settings' list.");
